...
namespace des
{
    public partial class Form1 : Form
    {
        ...
        {
            if (true/*textBox1.Text.Length == 8 && textBox2.Text.Length == 8*/)
            {
                X = textBox1.Text;
                X1 = BinaryConvert.ToBinary(BinaryConvert.ConvertToByteArray(X, Encoding.Default));
                k = Permut(BinaryConvert.ToBinary(BinaryConvert.ConvertToByteArray(textBox2.Text, Encoding.Default)), PC1);
                label0.Text = "X1 = " + X1;
                label1.Text = "k = " + k;
                ...
                Y = Permut(Y, IP1);
                label9.Text = "YF = " + Y;
                textBox1.Text = BinaryConvert.ConvertBytesToString(BinaryConvert.GetBytes(Y), Encoding.Default);
            }      
        }
